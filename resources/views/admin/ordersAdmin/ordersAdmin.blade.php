...
#myTable { border-collapse: collapse; width:100%; border:1px solid #ddd; font-size:16px; margin-bottom:50px; }
#myTable th, #myTable td { text-align:left; padding:12px; border:1px solid #ddd; vertical-align: middle; }
#myTable tr.header, #myTable tr:hover { background-color: rgb(255, 234, 247); }

/* Styling Select Status ala Dashboard */
.status-select {
    font-weight: 600;
    padding: 5px 10px;
    border-radius: 5px;
...
function myFunction() {
    ...
    for (var i = 1; i < tr.length; i++) {
        ...
        var found = false;
        // Cari di kolom ID, Customer, Produk, Status
        const cols = [0,1,2,7]; 
...
// Fungsi Update Status (Sama logic dengan Dashboard)
