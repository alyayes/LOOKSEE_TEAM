...
@section('content')
    ...
    <section class="main-about">
        <div class="main-about-us">
            ...
            <p>
                <d>LOOKSEE</d> is an innovative platform...
            </p>
            <br>
            ...
            @forelse($productsWoman as $row)
                <div class="product-card">
                    ...
                    <div class="product-details">
                        ...
                        <div class="actions">
                            <button class="btn favorite-btn" onclick="addToFavorites({{ $row['id_produk'] }})">
                                Add to Favorite
                            </button>

                            <button class="btn buy-now-btn" onclick="addToCart({{ $row['id_produk'] }})">
                                Add to Cart
                            </button>
                        </div>
                    </div>
